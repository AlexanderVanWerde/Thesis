...
One can define a direct image of graded $\Rees\A_Y^R$-modules similarly to the $\A_Y^R$-module direct image and these are coherent graded $\Rees\A_X^R$-modules similarly to \cref{thm: ConservationQuasiCoherentAndCoherentIfProper}. \todo{Check that direct image yields graded structure}
