...
\end{proposition}
\begin{proof}
  The construction for this spectral sequence may be found in chapter 5 of \cite{weibel1995introduction}
\end{proof}
\begin{definition}
...
This is to say that we know that the total cohomology $H^* = H^* \operatorname{Tot}(E)^\bullet$ admits a filtration such that $E^{pq}_\infty \cong F^p H^{p+q}/ F^{p-1} H^{p+q}$.
 ...
 \end{proposition}
 \begin{proof}
   This result may be found in chapter 5 of \cite{weibel1995introduction}.
 \end{proof}
...
\end{proposition}
\begin{proof}
  This result may be found in chapter 1 of \cite{dimca2004sheaves}.
\end{proof}
...
\end{theorem}
\begin{proof}
  This result may be found in chapter 1 of \cite{dimca2004sheaves}  or chapter 5 of \cite{weibel1995introduction}.
...
\end{proof}
\begin{proposition}[Cartan-Eilenberg]\label{prop: Cartan-Eilenberg}
  ...
  \begin{enumerate}
    ...
    \item[(iii)] The horizontal cocycles, coboundaries and cohomology on $P^{\bullet,p}$ form projective resolutions for the $p$-th cocycles, coboundaries and cohomology of $X^\bullet$ respectively.
  \end{enumerate}
\end{proposition}
\begin{proof}
  The proof may be found in chapter 5 of \cite{weibel1995introduction}.
...
\end{proposition}
\begin{proof}
  This result may be found in chapter 2 of \cite{dimca2004sheaves}.
\end{proof}
