...
The section on spectral sequences is based on \cite{weibel1995introduction}. A
...
The following proposition may be used in the motivating problem to recover some information on the cohomology of the total complex.
 \begin{proposition}\label{prop: BoundedFiltrationConvergentSpectral}
...
\begin{proof}
  ...
  The main ingredient is the spectral sequence associated to a double complex \cite{prop: BoundedFiltrationConvergentSpectral}.
\end{proof}
